...
#pragma warning restore 0414
        ...
        private IEnumerator Start()
        {
            ...
            Parent = GameManager.Instance.monsterHolder;
        ...
        private IEnumerator DeployTroops(int currentWave)
        {
            ...
            yield return new WaitUntil(() => spawnerPicker != null);
            ...
            while (!finishedDeploying)
            {
                ...
                if (toDeploy > 0)
                {
                    ...
                    presetIndexEndPoint = 0;
                    //use try catch to prevent error when not assign endPoints
                    try
                    {
                    ...
                    for (int i = 0; i < spawnAmount; i++)
                    {
                        ...
                        GameManager.Instance.AddEnemyToList(instance);
